	...
	<body style="background: #c2ddfc; padding: 0px; margin: 0px;">
		<div id="header">
			<div id="webname">
                ...
                <div id="header_icon">
                     <div id="home" ><a href="../../logout.php" onclick="return confirmAction()"><img src="../../public/img/nhanvienlogin/thoat.png" style="margin-top: 20px" alt="Thoát"></a></div>
                        <div id="logout" style="margin-top:3px; padding:0px; "><a href="../nhanvien.php"><img src="../../public/img/nhanvienlogin/trangchu.png" style="margin: 0px;" alt="Trang chủ"></a></div>
        	...
        	<!-- Start Thêm  thanh điều hướng_Tiên_20/06 -->
		        <div class="col-lg-4">
		                <nav class="breadcrumb-container" aria-label="breadcrumb">
		                    <ol style="background: aliceblue" class="breadcrumb">
        			...
        			<tr>
        				<td><label for="sel2">&emsp;Tên sự cố</label></td>
							...
							<select  name="tensuco" class="form-control" id="tensuco" style="width:150px;">
								  <option value="Phần Mềm">&emsp;&emsp;Phần Mềm</option>
...
<!--        				<td><input type="file" name="avatar"/></br></td>-->
					...
					<tr>
					  <td><label style="margin-top: 10px;" for="sel2">&emsp;Thiết bị hỏng</label></td>
						<td>
							<select  name="thietbihong" class="form-control" id="thietbihong" style="margin-top: 10px; width:150px;">
								  <option value="0">&emsp;Máy PC</option>
								  <option value="1">&emsp;Laptop</option>
								  <option value="2">&emsp;Máy tính bảng</option>
								  <option value="2">&emsp;Điện thoại</option>
								  <option value="3">&emsp;Máy in</option>
								  <option value="4">&emsp;Máy fax</option>
								</select>
					...
					<tr>
        				<td><label style="margin-top: 10px;" for="sel2">&emsp;Số máy</label></td>
   				  	  <td width="90%"> <input type="text" style="margin-top: 10px;width: 300px; height: 40px" name="somay" id="txtsomay" placeholder="Nhập số máy" required /></br> <div id="nhacLoiUn"></div></td>
        			</tr>
					<tr>	
						<td height="61"></td>
						<td style="">
