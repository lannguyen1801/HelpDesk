...
<html>
	...
	<body style="background: #c2ddfc; padding: 0px; margin: 0px;">
			...
			<div id="webname">
                ...
                <div id="header_icon">
                     <div id="home" ><a href="../logout.php"><img src="../public/img/nhanvienlogin/thoat.png" style="margin-top: 20px" alt="Thoát"></a></div>
                        <div id="logout" style="margin:0px; padding:0; "><a href="kythuat.php"><img src="../public/img/nhanvienlogin/trangchu.png" style="margin: 0px;" alt="Trang chủ"></a></div>
        ...
        <div id="content">
            <div id="information"><h2 style="text-align: center; color: #ed1e1e">Thông tin kỹ thuật</h2>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                    <tr >
                        <td style="text-align: left" width="24%"><div style="background-color: #f1eaea;height: 30px; line-height: 30px; margin-bottom:10px; padding-left:5px;border-style: dotted; border-width: 1px;">Mã kỹ thuật</div></td>
                        <td><div style="padding-left: 10px; color: #4286f4"><b><?php echo $Mnv ;?></b></div></td>
                    </tr>
                    <tr >
                        <td style="text-align: left" width="24%"><div style="background-color: #f1eaea;height: 30px; line-height: 30px; margin-bottom:10px; padding-left:5px;border-style: dotted; border-width: 1px;">Họ tên</div></td>
...
-->
                    <tr >
                        <td style="text-align: left" width="24%"><div style="background-color: #f1eaea;height: 30px; line-height: 30px;  margin-bottom:10px;padding-left:5px;border-style: dotted; border-width: 1px;">Chức vụ</div></td>
                        <td><div style="padding-left: 10px; color: #4286f4"><b><?php echo $chucvu?></b></div></td>
                    </tr>
                    <tr >
                        <td style="text-align: left" width="24%"><div style="background-color: #f1eaea;height: 30px; line-height: 30px; margin-bottom:10px; padding-left:5px;border-style: dotted; border-width: 1px;">Email</div></td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr style="padding: 5px">
                        <td style="padding-top: 5px">
                            ...
                            $thang=date('m');
                            $nam=date('Y');
                            echo '<div class="itemFuntion"><a href="suco.php"><img src="../public/img/nhanvienlogin/danhsach.jpg" height="67px" width="67px" alt=""></a></div>';
                            ?>

                        </td>
                        <td style="padding-top: 5px">
<!--                            <div class="itemFuntion"><a href="doimatkhau.php"><img src="../public/img/reset.png" height="67px" width="67px" alt=""></a></div>-->
							 <div class="itemFuntion"><img src="../public/img/nhanvienlogin/icon.jpg" height="67px" width="67px" alt=""></div>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding-top: 5px">
                            <div class="itemFuntion"><b>Danh sách sự cố</b></div>
                        </td>
                        <td style="padding-top: 5px">
